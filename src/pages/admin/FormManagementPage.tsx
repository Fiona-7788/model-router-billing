              ...
              onClick={async () => {
                ...
                try {
                  const response = await fetch(FUNCTION_URL, {
                    ...
                    headers: { "Content-Type": "application/json" },
                    credentials: "include",
                    body: JSON.stringify({ input: { action: "test_init_form", params: {} } }),
                  });
                  const raw = await response.json();
                  const result = raw.output ?? raw.data?.output ?? raw.data?.result ?? raw;
                  setTestResult(result);
              ...
              onClick={async () => {
                ...
                try {
                  const response = await fetch(FUNCTION_URL, {
                    ...
                    headers: { "Content-Type": "application/json" },
                    credentials: "include",
                    body: JSON.stringify({ input: { action: "get_form_schema", params: {} } }),
                  });
                  const raw = await response.json();
                  const result = raw.output ?? raw.data?.output ?? raw.data?.result ?? raw;
                  setTestResult(result);
              ...
              onClick={async () => {
                ...
                try {
                  const response = await fetch(FUNCTION_URL, {
                    ...
                    headers: { "Content-Type": "application/json" },
                    credentials: "include",
                    body: JSON.stringify({ input: { action: "test_write_formats", params: {} } }),
                  });
                  const raw = await response.json();
                  const result = raw.output ?? raw.data?.output ?? raw.data?.result ?? raw;
                  setTestResult(result);
